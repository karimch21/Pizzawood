...
// Основные настройки:
$recipients = ['barinov_9927@mail.ru', 'karimch1999@yandex.ru', '21karimchs1999@gmail.com']; // Получатели писем
// $subject = $_SERVER['SERVER_NAME'] . ' — Письмо'; // Тема письма
...
$smtp_username = 'pwood_2020@mail.ru'; // Почтовый ящик, с которого будут отправляться письма
$smtp_password = 'Prorok12345'; // Пароль почтового ящика, с которого будут отправляться письма
